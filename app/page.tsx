...
export default function Home() {
  return (
    <main className="relative min-h-screen">
      ...
      {/* Hero content */}
      <div>
        {/* ExereCorp logo below navbar, centered */}
        ...
        <section className="w-full flex flex-col items-start px-12 pt-20 max-w-4xl">
          ...
          <div className="mt-8 flex items-center space-x-6">
            <Link href="/contact">
              <Button
                variant="outline"
                size="lg"
                className="flex items-center gap-2 bg-slate-950"
              >
                Get Started
            ...
            <div className="flex items-center space-x-4">
              <Link href="https://x.com/ExereCorp/" target="_blank">
                <div className="w-10 h-10 flex items-center justify-center rounded-full bg-white/20 hover:bg-black transition">
                  <Twitter className="w-5 h-5 text-white" />
                </div>
              </Link>
              <Link href="https://www.linkedin.com/company/104365518/" target="_blank">
                <div className="w-10 h-10 flex items-center justify-center rounded-full bg-white/20 hover:bg-blue-600 transition">
                  <Linkedin className="w-5 h-5 text-white" />
                </div>
              </Link>
              <Link href="https://www.instagram.com/exere_corp/" target="_blank">
                <div className="w-10 h-10 flex items-center justify-center rounded-full bg-white/20 hover:bg-pink-500 transition">
                  <Instagram className="w-5 h-5 text-white" />
                </div>
              </Link>
              <Link href="https://web.facebook.com/profile.php?id=61581195950562" target="_blank">
